	...
	<div>
		...
		<div class="pb50">
			<div class="pay">
				...
				<mt-field label="银行卡号" v-model="proname" readonly="readonly"></mt-field>
				<mt-field label="还款额" v-model="proname" readonly="readonly"></mt-field>
			...
			<mt-button size="large" type="primary" id="button-al" class="button-al" >提交</mt-button>
		</div>
	</div>
</template>
